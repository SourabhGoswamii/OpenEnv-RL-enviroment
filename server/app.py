...
"""
FastAPI application for the Myenv Environment.

This module creates an HTTP server that exposes the MyenvEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn myenv.server.app:app --workers 4
    """
    import uvicorn
